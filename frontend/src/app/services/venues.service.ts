...
export class VenuesService {
  ...
  private getVenueFromEdition(edition: String): Observable<Venue> {
    return this.sponsorsApiService.getVenueFromEdition(edition);
  }

  private getCurrentVenue(): Observable<Venue> {
    return this.sponsorsApiService.getCurrentVenue();
  }

  uploadStand(stand: Stand): Observable<Venue> {
    return this.sponsorsApiService.uploadStand(stand);
  }

  deleteStand(id: number): Observable<Venue> {
    return this.sponsorsApiService.deleteStand(id);
  }
}
